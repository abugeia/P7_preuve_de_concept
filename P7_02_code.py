...
if torch.cuda.is_available():
    print('Eval with gpu')
    subprocess.call(['python', 'val.py', '--weights', 'yolov5s.pt', '--data', 'data/coco.yaml', '--img', '640', '--iou', '0.65', '--half'])
else:
    print('Eval with cpu')
    subprocess.call(['python', 'val.py', '--weights', 'yolov5s.pt', '--data', 'data/coco.yaml', '--img', '640', '--iou', '0.65'])
os.chdir(dname)
